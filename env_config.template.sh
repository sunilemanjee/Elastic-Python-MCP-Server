...
export ELSER_INFERENCE_ID="${ELSER_INFERENCE_ID:-.elser-2-elasticsearch}"
export E5_INFERENCE_ID="${E5_INFERENCE_ID:-.multilingual-e5-small-elasticsearch}"
export RERANK_INFERENCE_ID="${RERANK_INFERENCE_ID:-.rerank-v1-elasticsearch}"
